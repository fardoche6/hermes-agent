...
DEFAULT_CONFIG = {
    ...
    "kanban": {
        ...
        # Auto-decomposition mutates the task graph and can launch workers.
        # It is opt-in: when false (the safe default), decomposition is
        # manual via `hermes kanban decompose <id>` or the dashboard button.

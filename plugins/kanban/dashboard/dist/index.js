...
(function () {
  ...
  const COLUMN_ORDER = ["triage", "todo", "scheduled", "ready", "running", "blocked", "review", "review_approved", "done"];
  ...
  const FALLBACK_COLUMN_HELP = {
    ...
    review: "Implementation submitted for independent review",
    review_approved: "Review approved; finalization claim is active",
    done: "Completed",
    archived: "Archived",
  };
  ...
  const COLUMN_DOT = {
    ...
    review_approved: "hermes-kanban-dot-review-approved",

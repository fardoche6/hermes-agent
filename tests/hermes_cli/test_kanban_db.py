...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('API Error: 529 Overloaded {\\\\"token\\\\": \\\\"double-escaped-secret\\\\"}', ("double-escaped-secret",), "API Error: 529 Overloaded"),
        ('API Error: 529 Overloaded {\\\\\\\\"PaSsWoRd" \t : \\\\\\\\"triple-escaped-secret\\\\\\\\"}', ("triple-escaped-secret",), "API Error: 529 Overloaded"),
        ('API Error: 529 Overloaded {\\\\"AuThOrIzAtIoN"\t:\\\\"raw-authorization-secret\\\\"}', ("raw-authorization-secret",), "API Error: 529 Overloaded"),

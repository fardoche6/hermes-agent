...
def test_gateway_dispatcher_disables_corrupt_board_without_traceback(
    ...
    # The first tick opens one dispatch connection and one shared probe
    # connection. The quarantined second tick skips dispatch but still
    # probes once, for three total board connections.
